            ...
            _b_: function(t) {
                ...
                null != e.model ? (l.createdCallback = function() {
                    ...
                    for (p = 0; p < t.length; p++) {
                        ...
                        if ("bar" == e.chartType) {
                            ...
                            for (c = 0; c < a.length; c++) try {
                                a[c] != O.dat && (i[_].push(t[p][c]), 1 == r ? k += parseFloat(t[p][c]) : (S[c] = 0, parseFloat(t[p][c]) > 0 && t[p][c] != O.udf && (S[c] = parseFloat(t[p][c]))), _++)
                            } catch (t) {}
                            if (i[_].push(k), u[p] = 1 == r ? k : maxArray(S), d[0] != O.dat) {
                                var C = 0,
                                    T = [];
                                T[0] = 0;
                                var A = 0;
                                for (c = 0; c < d.length; c++)
                                    if (null != t[p][d[c]]) try {
                                        l[A].push(t[p][d[c]]), 1 == r ? C += parseFloat(t[p][d[c]]) : (C[c] = 0, parseFloat(t[p][d[c]]) > 0 && (T[c] = parseFloat(t[p][d[c]]))), A++
                                    } catch (t) {}
                    ...
                    for (h = 0; h < i.length; h++) {
                        ...
                        if ("bar" == e.chartType) {
                            ...
                            for (p = 1; p <= d.length; p++) try {
                                d[p] != O.dat && (l[_].push(i[h][p]), 1 == r ? k += parseFloat(i[h][p]) : (S[p] = 0, parseFloat(i[h][p]) > 0 && i[h][p] != O.udf && (S[p] = parseFloat(i[h][p]))), _++)
                            } catch (t) {}
                            if (l[_].push(k), g[h] = 1 == r ? k : maxArray(S), c[0] != O.dat) {
                                var C = 0,
                                    T = [];
                                T[0] = 0;
                                var A = 0;
                                for (p = 0; p < c.length; p++)
                                    if (i[h][c[p]] != O.udf && null != i[h][c[p]]) try {
                                        a[A].push(i[h][c[p]]), 1 == r ? C += parseFloat(i[h][c[p]]) : (C[p] = 0, parseFloat(i[h][c[p]]) > 0 && (T[p] = parseFloat(i[h][c[p]]))), A++
                                    } catch (t) {}
                    ...
                    if ("bar" == e.chartType) {
                        ...
                        for (h = 0; h < d.length; h++) d[h] != O.dat && (I[p] = {
                            type: "bar",
                            label: d[h],
